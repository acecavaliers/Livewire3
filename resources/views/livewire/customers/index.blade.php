<div class="py-5">
        ...
        <div id="alert-1" x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 3500)" class="flex items-center p-4 mb-4 text-blue-50 rounded-lg bg-blue-900 position: absolute top-4 right-11 min-w-96" role="alert">
            ...
            <div class="ms-3 text-sm font-medium">
              ...
              <button type="button" class="ms-auto -mx-1.5 -my-1.5 bg-blue-50 text-blue-500 rounded-xl focus:ring-2 focus:ring-blue-400 p-1.5 hover:bg-blue-200 inline-flex items-center justify-center h-5 w-5" data-dismiss-target="#alert-1" aria-label="Close">
